...
public class CakeView extends SurfaceView {
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        for(int i = 1; i <= cakeModel.candlesOnCake; i++) {
            drawCandle(canvas, cakeLeft + i * cakeWidth / (cakeModel.candlesOnCake + 1) -
                    i * candleWidth / (cakeModel.candlesOnCake + 1), cakeTop);
        }
    }//onDraw
